...
suspend fun convertEarthDtoToDomain(earthApiDtoPhotos: List<EarthApiDto>
): List<EarthModel> =
...
//                    imagePath =earthApiDto.image
                   imagePath = pathImage(convertText(earthApiDto.date),earthApiDto.image, BuildConfig.NASA_API_KEY)
                )
            }
        }
